    ...
    <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
      <div className="rounded-[2rem] border border-white/10 bg-slate-900/70 p-4 shadow-2xl shadow-black/20 sm:p-6">
        ...
        <div className="mt-6 space-y-4 text-sm text-slate-300 sm:text-base">
          <div className="flex items-center gap-3"><FiPhone className="text-emerald-400" /> <span>+91 98765 43210</span></div>
        ...
        <a href="https://wa.me/919876543210" className="mt-6 inline-flex rounded-full bg-emerald-500 px-4 py-3 font-semibold text-slate-950">WhatsApp Now</a>
      </div>
      <div className="rounded-[2rem] border border-white/10 bg-slate-900/70 p-4 shadow-2xl shadow-black/20 sm:p-6">
        <iframe
          title="RCM Turf Map"
